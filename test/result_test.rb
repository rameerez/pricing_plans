...
class ResultTest < ActiveSupport::TestCase
  ...
  def test_result_immutability
    ...
    refute result.respond_to?(:billable=)
  end

  def test_result_equality_based_on_attributes
    org = create_organization
    
    result1 = PricingPlans::Result.grace("Message", limit_key: :projects, billable: org)
    result2 = PricingPlans::Result.grace("Message", limit_key: :projects, billable: org)
    result3 = PricingPlans::Result.grace("Different", limit_key: :projects, billable: org)
    ...
    assert_equal result1.billable, result2.billable
  ...
  def test_result_with_complex_billable_objects
    # Test with different types of billables
    ...
    assert_equal project, result.billable
