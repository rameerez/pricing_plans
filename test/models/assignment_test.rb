...
class AssignmentTest < ActiveSupport::TestCase
  ...
  def test_validation_requires_plan_owner
    ...
    assert assignment.errors[:plan_owner].any?
  end
  ...
  def test_uniqueness_per_plan_owner
    ...
    assert duplicate.errors[:plan_owner_type].any?
  end

  def test_different_plan_owners_can_have_assignments
  ...
  def test_polymorphic_plan_owner_association
    ...
    assert_equal @org, assignment.plan_owner
    assert_equal "Organization", assignment.plan_owner_type
  ...
  def test_find_by_plan_owner
    ...
    found = PricingPlans::Assignment.find_by(
      plan_owner_type: @org.class.name,
      plan_owner_id: @org.id
    )
